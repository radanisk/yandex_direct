...
module YandexDirect
  module V5
    module Ads
      ...
      def add_ads(params)
        Utils.new.perform_request(self, @token, 'ads', 'add', params)
      end
      ...
      def ads(params)
        Utils.new.perform_request(self, @token, 'ads', 'get', params)
      end
      ...
      def moderate_ads(params)
        Utils.new.perform_request(self, @token, 'ads', 'moderate', params)
      end
    end
  end
end
